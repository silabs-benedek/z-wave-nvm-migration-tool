...
#define ZAF_FILE_ID_APP_NAME                (ZAF_FILE_ID_BASE + 12)
#define ZAF_FILE_SIZE_APP_VERSION           (sizeof(uint32_t))

#define ZAF_FILE_ID_BASE_800s_XG23        (0x41000)
#define ZAF_FILE_ID_APP_VERSION_800s_XG23 (ZAF_FILE_ID_BASE_800s_XG23 + 0)

#define ZAF_FILE_ID_BASE_800s_XG28          (0x5A000)
#define ZAF_FILE_ID_APP_VERSION_800s_XG28   (ZAF_FILE_ID_BASE_800s_XG28 + 0)

#define ZAF_FILE_ID_APP_NAME_800s_XG23      (ZAF_FILE_ID_BASE_800s_XG23 + 12)
#define ZAF_FILE_ID_APP_NAME_800s_XG28      (ZAF_FILE_ID_BASE_800s_XG28 + 12)
...
typedef struct
{
  ...
  uint8_t     enablePTI;
  int16_t     maxTxPower;
} SApplicationConfiguration_7_18_1;
...
typedef struct
{
  ...
  uint8_t     enablePTI;
  int16_t     maxTxPower;
  uint8_t     nodeIdBaseType;
} SApplicationConfiguration_7_21_x;
...
#define FILE_SIZE_APPLICATIONCONFIGURATION_7_18_1 (sizeof(SApplicationConfiguration_7_18_1))
#define FILE_SIZE_APPLICATIONCONFIGURATION_7_21_x (sizeof(SApplicationConfiguration_7_21_x))
...
#define FILE_SIZE_PROPRIETARY_1        (sizeof(dcdc_configuration_file_t))
