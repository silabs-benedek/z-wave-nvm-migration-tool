...
#define FILE_SIZE_CONTROLLERINFO_NVM719   (sizeof(SControllerInfo_NVM719))
...
#define FILE_ID_NODEINFO_BASE_V5           (0x50200)
#define FILE_SIZE_NODEINFO_BASE_V5         (sizeof(SNodeInfo) * NODEINFOS_PER_FILE)
...
#define NUMBER_OF_NODEROUTECACHE_V5_FILES  29  // supporting 232 nodes
#define FILE_ID_NODEROUTECAHE_BASE_V5      (0x51400)
#define FILE_SIZE_NODEROUTECAHE_BASE_V5    (sizeof(SNodeRouteCache) * NODEROUTECACHES_PER_FILE)
...
#define FILE_ID_NODEINFO_LR_BASE_V5        (0x50800)
#define FILE_SIZE_NODEINFO_LR_BASE_V5      (sizeof(SLRNodeInfo) * LR_NODEINFOS_PER_FILE)
...
/* In version 5 the file format for S2 PAN changed. */
#define SPAN_TABLE_SIZE                    254
#define FILE_ID_S2_SPAN_BASE_V5            (0x52000)
#define FILE_SIZE_S2_SPAN_BASE_V5          42

/* In version 5 the file format for S2 MPAN changed. */
#define MPAN_TABLE_SIZE                    254
#define FILE_ID_S2_MPAN_BASE_V5            (0x53000)
#define FILE_SIZE_S2_MPAN_BASE_V5          22

/* In version 5 the file format has SUC NODE changed. */
...
#define FILE_ID_SUCNODELIST_BASE_V5        (0x54000)
#define FILE_SIZE_SUCNODELIST_BASE_V5      (sizeof(SSucNodeList_V5))
